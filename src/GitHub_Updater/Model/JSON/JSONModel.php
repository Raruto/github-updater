...
abstract class JSONModel implements JSONModelInterface
{
	...
	public abstract function add_plugin( $plugin_path, $plugin_data );

	public abstract function initialize_json_manifest();

	public abstract function finalize_json_manifest();
